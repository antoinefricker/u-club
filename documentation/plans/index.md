...
- [016 - 25/04/2026 - Admin Team Assignments Edition](016-25042026-team-assignments-edition.md) — `GET /members/:memberId/teams` + `PUT /teams/:teamId/members/:memberId` API routes plus a "Team assignments" section in the admin member edit page (add / edit role / delete)
