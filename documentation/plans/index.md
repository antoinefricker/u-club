...
- [019 - 27/04/2026 - Team Assignment Multiple Roles](019-27042026-team-assignment-multiple-roles.md) — Allow members to hold multiple distinct roles on the same team via `UNIQUE(team_id, member_id, role)`; remove `PUT /team-assignments/:id` and the inline role-edit UI
