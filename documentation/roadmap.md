...
- [ ] **Seed database** — 2 clubs, 45 teams, 25 members each / allow to clear
- [ ] **Centralized error handling** — Add Express error middleware to return consistent JSON errors instead of HTML stack traces
